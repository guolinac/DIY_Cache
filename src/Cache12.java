...
/**
 * 缓存过期时间随机：避免高并发访问时，缓存雪崩
 * @param <A>
 * @param <V>
 */
public class Cache12<A, V> implements Computable<A, V> {
    // Future包装value
    private final Map<A, Future<V>> cache = new ConcurrentHashMap<>();

    private final Computable<A, V> c;

    public Cache12(Computable<A, V> c) {
        this.c = c;
    }
    ...
    public static void main(String[] args) throws Exception {
        Cache12<String, Integer> expensiveComputer = new Cache12<>(new MayFail());
        // 第一个线程
